...
struct MoreApps {
    static func getMoreApps()->[[String : String]] {
...
//    arrFAQs.append(["question":"How does premium membership help me?","answer":"The premium membership includes unlimited use of all premium features with no advertisements. Including Fast mode and auto-paste feature for direct messages, as well as an unlimited sticker collection."])
//    arrFAQs.append(["question":"How does the free trial work?","answer":"You are not charged during the first three days of your trial. After that, access to premium features requires payment."])
//    arrFAQs.append(["question":"Is there a one-time payment or automatic renewal?","answer":"The subscription is an automatic monthly/yearly payment, which automatically renews unless turnedoff at least 24-hours before the current period ends. There is \"Daily Pass\" option available for one day that does not renew automatically."])
//    arrFAQs.append(["question":"Can I cancel my subscription anytime?","answer":"Yes, you can go to your iTunes Account settings to manage your subscription."])
//    arrFAQs.append(["question":"Can I restore my data once I delete the app?","answer":"No, When you delete the ClickToChat Application, all your data is removed as well. Make sure to back up all your important data somewhere else before uninstalling the app."])
